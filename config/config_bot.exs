...
config :backend, QuantumScheduler,
  jobs: [
    ...
    {"31 17 * * Wed", fn -> Hearthstone.DeckTracker.PeriodManager.update_brawl_period_start() end},
    {"1 18 * * Wed", fn -> Hearthstone.DeckTracker.PeriodManager.update_brawl_period_start() end},
    {"31 18 * * Wed", fn -> Hearthstone.DeckTracker.PeriodManager.update_brawl_period_start() end},
    ...
    {"* * * * *", fn -> Hearthstone.DeckTracker.AggregationJob.cancel_old() end},
...
queues =
  [
    ...
    deck_tracker_aggregator_fast: 3,
    deck_tracker_aggregator_slow: 2,
    gm_stream_live: 1,
