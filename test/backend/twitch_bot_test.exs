defmodule Backend.TwitchBotTest do
  ...
  @valid_attrs %{enabled: true, message: "some message", message_regex: true, message_regex_flags: "some message_regex_flags", name: "some name", random_chance: 120.5, response: "some response", sender: "some sender", sender_regex: true, sender_regex_flags: "some sender_regex_flags", type: "some type"}
