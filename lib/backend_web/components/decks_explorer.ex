  ...
  def render(assigns) do
    ...
    <div>
      <div :if={{params, search_filters} = {@actual_params, @search_filters}}>
        ...
        <PlayableCardSelect id={"player_deck_includes"} param={"player_deck_includes"} selected={IO.inspect(params["player_deck_includes"], label: :upstream_selected) || []} title="Include cards"/>
