defmodule FunctionComponents.DropdownOld do
  @moduledoc "For the navbar"
  ...
  def menu(assigns) do
    ~H"""
      <div
        class={["has-dropdown", "dropdown", "is-hoverable", @class]}
  ...
  def item(assigns) do
    ~H"""
    <.link
        class={[@base_class, @class, @selected && "is-active"]}
        {@rest}
        tabindex="0"
