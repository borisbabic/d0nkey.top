  ...
  def subtitle(week) do
    case week do
      ...
      "Week 2" ->
        ...
        ~F"""
        Format: <a href="https://hearthstone.blizzard.com/en-us/news/23761137/hearthstone-grandmasters-2022-kicks-off-this-weekend" target="_blank">Trio<HeroIcons.external_link /></a>
        """
