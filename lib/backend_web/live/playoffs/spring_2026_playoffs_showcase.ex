defmodule BackendWeb.Spring2026PlayoffsShowcaseLive do
  @moduledoc false
  use BackendWeb, :surface_live_view
  alias FunctionComponents.Battlefy

  @tournament_ids [
    "69fbb6e378ae0900138585eb",
    "69fbb38078ae0900138585c9",
    "69fbb87078ae0900138585f9"
  ]
  ...
  def mount(_params, session, socket) do
    ...
    {:ok,
     ...
     |> assign(:page_title, "Spring 2026 Playoffs")}
  end
