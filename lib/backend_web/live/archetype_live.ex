defmodule BackendWeb.ArchetypeLive do
  ...
  def render(assigns) do
    ...
    <div class="subtitle is-6">
      ...
      <AggLogSubtitle criteria={@stats_params} />
    </div>
    ...
    <div class="columns is-multiline is-mobile is-narrow is-centered">
      <div class="column">
        ...
        <OpponentStatsTable id="archetype_stats" format_dropdown?={true} target={{"archetype", @archetype}} live_view={__MODULE__} path_params={to_string(@archetype)} params={@stats_params} />
      </div>
