defmodule Dreamhack do
  @current_info [
    ...
    {:"Asia-Pacific", "60f53b7f2a52fc4c16f2c2b9", ~N[2021-07-26 07:00:00], ~N[2021-08-03 04:20:00],
     "/fantasy/leagues/join/9b2b6d75-07cf-4a16-a519-0349ca247b5f"},
  ...
  def current do
    ...
    |> Enum.filter(fn {_, _, start, end_time, _} ->
      NaiveDateTime.before?(start, now) &&
        NaiveDateTime.after?(end_time, now)
    end)
