defmodule Backend.HSDeckViewer do
  ...
  def create_link(deckstrings) do
    ...
    "https://hsdeckviewer.github.io/?#{query}"
  end

  def hdv_link?(link) when is_binary(link),
    do: link =~ "hsdeckviewer.com" or link =~ "hsdeckviewer.github"
  ...
  iex> Backend.HSDeckViewer.extract_codes("https://hsdeckviewer.github.io/?deckstring=AAECAf0EBvisA8W4A9DOA9nRA%2FzdA5PhAwzmBJ%2BbA%2BKbA%2F%2BdA%2FusA%2F2sA%2FOvA4XNA83OA%2FfRA%2F7RA%2FjdAwA%3D")
  ["AAECAf0EBvisA8W4A9DOA9nRA/zdA5PhAwzmBJ+bA+KbA/+dA/usA/2sA/OvA4XNA83OA/fRA/7RA/jdAwA="]
