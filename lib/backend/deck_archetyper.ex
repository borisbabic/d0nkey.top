...
defmodule Backend.DeckArchetyper do
  ...
  defp archetype(deck, card_info) do
    case {deck, Deck.class(deck)} do
      ### Use the line below after you finish the deathknight archetyper
      # {%{format: 2}, "DEATHKNIGHT"} -> DeathKnightArchetyper.standard(card_info)
      # and the same for other classes when you make those files
  ...
  ##############################
  # delete the following lines after everything below is empty
  #############################
  @type card_info :: Backend.DeckArchetyper.ArchetyperHelpers.card_info()
  ...
  #######################################################################################
  #######################################################################################
  ###### EVERYTHING BELOW THIS SHOULD END UP IN A DIFFERENT FILE
  #######################################################################################
  #######################################################################################
  #######################################################################################
  #######################################################################################
