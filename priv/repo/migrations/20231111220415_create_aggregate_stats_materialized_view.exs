defmodule Backend.Repo.Migrations.CreateAggregateStatsMaterializedView do
  use Ecto.Migration
  ...
  def up do
    create_sql = """
      CREATE MATERIALIZED VIEW dt_aggregated_stats AS
      WITH agg_ranks(
          min_rank,
          max_rank,
          min_legend_rank,
  ...
  def down, do: execute("DROP MATERIALIZED VIEW IF EXISTS dt_aggregated_stats")
end
